...
export class EmailValidationService {
    ...
    /**
     * Pattern za proveru da li je email adresa ispravno uneta
     */
    ...
    /**
     * Proverava da li je prosledjena adresa ispravnog email formata
     * @param address - adresa koju proveravamo
     * @returns true/false
     */
    isValidEmailAddress(address: string): boolean {
        return this.emailRegex.test(address);
    }
}